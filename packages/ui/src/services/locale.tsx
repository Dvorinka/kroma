...
export function LocaleProvider({
  ...
  useEffect(() => {
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: fires once when the user signs in with no language; the account-locale effect handles subsequent changes.
  }, [wantsSync]);
